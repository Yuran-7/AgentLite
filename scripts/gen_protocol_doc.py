...
def generate() -> str:
    ...
    sections = [
        ...
        "\n",
        _model_section("SessionSetMemoryCommand", SessionSetMemoryCommand),
        "\n",
        _model_section("SessionSetMemoryResult", SessionSetMemoryResult),
        "\n",
        _model_section("SessionSetStatsCommand", SessionSetStatsCommand),
        "\n",
        _model_section("SessionSetStatsResult", SessionSetStatsResult),
        "\n",
        _model_section(
            "SessionSetWorkspaceCommand",
            SessionSetWorkspaceCommand,
        ...
        "\n",
        _model_section("MemorySearchCommand", MemorySearchCommand),
        "\n",
        _model_section("MemorySearchResult", MemorySearchResult),
        "\n",
        _model_section("MemoryListCommand", MemoryListCommand),
        "\n",
        _model_section("MemoryListResult", MemoryListResult),
        "\n",
        _model_section("MemoryGenerateCommand", MemoryGenerateCommand),
        "\n",
        _model_section("MemoryGenerateResult", MemoryGenerateResult),
        "\n",
        _model_section("MemoryCommitCommand", MemoryCommitCommand),
        "\n",
        _model_section("MemoryCommitResult", MemoryCommitResult),
        "\n",
        _model_section("MemoryRejectCommand", MemoryRejectCommand),
        "\n",
        _model_section("MemoryRejectResult", MemoryRejectResult),
        "\n",
        _model_section("MemoryDeleteCommand", MemoryDeleteCommand),
        "\n",
        _model_section("MemoryDeleteResult", MemoryDeleteResult),
        "\n## Server Push\n\n",
        ...
        "\n## Run Events\n\n",
        "Session events are appended to `sessions/.../<session_id>/events.jsonl`; "
        "standalone runs use a single `events.jsonl` file. Events are also forwarded "
        "over IPC to subscribed clients.\n\n",
        ...
        "\n",
        _model_section("PlanUpdatedEvent", PlanUpdatedEvent,
            {"type": "plan.updated", "run_id": run_id,
